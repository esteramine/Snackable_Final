...
import com.example.snackable.FoodAdditiveDetailActivity.FoodAdditiveDetailActivity;
...
public class ProductItemFAAdapter extends RecyclerView.Adapter<ProductItemFAHolder> {
    ...
    public ProductItemFAHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_additive_for_product_detail_activity, parent, false);
    ...
    public void onBindViewHolder(@NonNull ProductItemFAHolder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClickListener(View v, int position) {
                Intent intent = new Intent(c, FoodAdditiveDetailActivity.class);
